...
- **`table_create_v1.1.0.sql`**: Comprehensive table creation script with all entity definitions and
  constraints
- **`schema.sql`**: Database and user creation scripts for development and production environments
- **`table_data_v1.1.0.sql`**: Initial seed data for clubs (HPSC, PMPSC, SOSC)
...
4. Run `scripts/table_create_v1.1.0.sql` to create all tables with constraints
5. Run `scripts/table_data_v1.1.0.sql` to insert initial club seed data

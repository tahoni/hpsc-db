...
Use `../../RELEASE_NOTES.md` for the latest consolidated release notes and `../../HISTORY.md` for narrative release context.

## 📚 Available Versions

- **[v3.0.0](./RELEASE_NOTES_v3.0.0.md)** - Schema Maintenance & Migration Reliability (Mar 13, 2026) - **Stable**
